    ...
    <Card className="p-0 overflow-hidden hover:shadow-md transition-shadow duration-200 min-h-[11rem] flex flex-col">
      ...
      <div className="flex items-start gap-3 p-3">
        ...
        <div className="flex-1 min-w-0">
          <h3
            className="font-semibold text-sm text-gray-900 dark:text-gray-100 leading-tight mb-1"
            title={player.name}
          >
            {player.name}
          </h3>
                ...
                currentData.market_value !== player.market_value && (
                  <div className="text-xs mt-1 space-y-0.5">
                    ...
                    >
                      ...
                      €
                      {formatNumber(
                        Math.abs(currentData.market_value - player.market_value)
                      )}{" "}
                      (
                      {(
                        (Math.abs(
